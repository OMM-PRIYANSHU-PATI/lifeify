# Feature 371: AI Explanation of Validated Interactions
...
| Feature Number | 371 |
| Version | V3 |
| Category | AI Medication Intelligence |
| Feature Key | `ai_explanation_of_validated_interactions` |

## Purpose

AI Explanation of Validated Interactions helps the user understand their health data through an AI layer that operates only on validated, permissioned, and provenance-aware records.
...
The feature requires the minimum structured data needed to represent `AI Explanation of Validated Interactions` safely:
...
Additional fields and entities should be scoped to the category `AI Medication Intelligence` and linked by stable IDs with source metadata.
...
Show a calm empty state explaining that no `AI Explanation of Validated Interactions` data exists yet, then offer the safest next action: connect a supported source, enter data manually, use quick log, answer a short quiz, upload a document, or invite an approved contributor where applicable.
