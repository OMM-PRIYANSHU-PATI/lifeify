# Feature 349: AI Workout Personalization
...
| Version | V3 |
| Category | AI Fitness |
| Feature Key | `ai_workout_personalization` |

## Purpose

AI Workout Personalization helps the user understand their health data through an AI layer that operates only on validated, permissioned, and provenance-aware records.
...
The feature requires the minimum structured data needed to represent `AI Workout Personalization` safely:
...
Show a calm empty state explaining that no `AI Workout Personalization` data exists yet, then offer the safest next action: connect a supported source, enter data manually, use quick log, answer a short quiz, upload a document, or invite an approved contributor where applicable.
